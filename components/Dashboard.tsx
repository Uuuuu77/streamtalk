                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="text-center space-y-2">
                    <Button
                      ...
                      variant="outline"
                      size="lg"
                      className={`w-full h-16 ${micEnabled 
                  ...
                  <div className="text-center space-y-2">
                    <Button
                      ...
                      variant="outline"
                      size="lg"
                      className={`w-full h-16 ${volumeEnabled 
                  ...
                  <div className="text-center space-y-2">
                    <Button
                      ...
                      variant="outline"
                      size="lg"
                      className="w-full h-16 border-yellow-500 text-yellow-400 hover:bg-yellow-500/10"
                    >
                  ...
                  <div className="text-center space-y-2">
                    <Button
                      ...
                      variant="outline"
                      size="lg"
                      className="w-full h-16 border-purple-500 text-purple-400 hover:bg-purple-500/10"
                    >
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-sm">Start hosting or join a session to see activity here</p>
                </div>
              </CardContent>
            </Card>
          </div>
