          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
            ...
            {user ? (
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto">
                <div className="bg-green-500/20 border border-green-500/30 rounded-lg px-3 py-2 flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-start">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center px-4 sm:px-0">
              <Button
                ...
                size="lg"
                className="bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800 disabled:opacity-50 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto min-h-[48px] sm:min-h-[56px] min-w-[200px]"
              >
                {isCreatingSession ? (
                  <>
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-purple-400 text-purple-400 hover:bg-purple-400/10 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto min-h-[48px] sm:min-h-[56px] min-w-[200px]"
              >
            ...
            {!user && (
              <p className="text-sm text-gray-400 mt-3 sm:mt-4 px-4 sm:px-0">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Create your account in seconds</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Start a stream or join an existing session</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm sm:text-base">Engage with your audience in real-time</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <Button
              onClick={() => setShowAuth(true)}
              size="lg"
              className="bg-purple-600 hover:bg-purple-700 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto min-h-[48px] sm:min-h-[56px] w-full sm:w-auto max-w-sm"
            >
              Get Started Free
